fun main() {
    ...
    fun part2(input: List<String>): Int {
        ...
        fun String.findFirstSubstringAmong(words: Set<String>): String? {
        ...
        fun calibrationValue(word: String): Int {
            ...
            val first = digitsMap[word.findFirstSubstringAmong(digitsMap.keys) ?: "0"] ?: 0
            val last = reversedDigitsMap[reversedWord.findFirstSubstringAmong(reversedDigitsMap.keys) ?: "0"] ?: 0
            return (first * 10 + last)
        }
        return input.sumOf(::calibrationValue)
    }
